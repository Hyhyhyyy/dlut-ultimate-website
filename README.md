...
0. 招新二维码进入 `/recruit.html`；该页面不包含表单，不收集个人信息。未参加过线下训练的同学先加入 QQ 群和微信群，参加一次训练后再使用成员登记。
...
7. 参加过正式比赛的已公开成员从 `/debut.html` 登记首次比赛；后台会提示提交身份是否与成员申请一致，管理员核实后，该成员进入“黑蚁飞盘队”分区并仅公开入队年份。

招新简版、官网、审核后台、照片上传页和首次比赛登记页的主题海报、标准二维码及下载入口位于 `/qrcodes.html`。
